      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="tampil_produk_pelanggan.php">Produk</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="tampil_transaksi.php">transaksi</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="masukkan_keranjang.php">keranjang</a>
            </li>
            <li class="nav-item">

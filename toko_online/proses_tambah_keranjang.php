...
if ($_POST) {
    ...
    if (mysqli_num_rows($result_check) > 0) {
        ...
        if (mysqli_query($conn, $query_update)) {
            ...
            echo "<script>alert('Gagal memperbarui keranjang');location.href='home_pelanggan.php';</script>";
        }
    } else {
        ...
        if (mysqli_query($conn, $query_insert)) {
            echo "<script>alert('Produk berhasil ditambahkan ke keranjang');location.href='home_pelanggan.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan produk ke keranjang');location.href='home_pelanggan.php';</script>";
        }
    }
} else {
    echo "<script>alert('Aksi tidak valid');location.href='home_pelanggan.php';</script>";
}
?>